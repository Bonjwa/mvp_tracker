...
const RAID_ROLES = ['SB', 'LK', 'Devo', 'HP', 'Prof', 'Asura', 'Wiz', 'DPS (sniper/sinx/creo)', 'Dancer/Bard'];
...
function createRaidButtons() {
  ...
  const topRoles = ['SB', 'LK', 'Devo', 'HP', 'Prof'];
  const bottomRoles = ['Asura', 'Wiz', 'DPS (sniper/sinx/creo)', 'Dancer/Bard'];
